...
# this program is mostly still the shell provided for an earlier assignment but
# I have modified it to be smaller and more efficient for a rules referencing platform
...
class Main(wx.Frame):
    def __init__(self, parent, title: str, gui: 'ChatbotGUI', gif_path: str, show_timestamp: bool = False):
        ...
        # input chat label
        self.input_chat_label = wx.StaticText(self.io_panel, label="Ask a Question:")
        ...
        # input chat label
        self.output_chat_label = wx.StaticText(self.io_panel, label="History:")
